...
namespace ORDesignerWalkthrough
{
    ...
    partial void DeleteOrder(Order instance);
		...
		{
			Customer original = ((Customer)(Customers.GetOriginalEntityState(obj)));
			this.UpdateCustomers(obj.CustomerID, obj.CompanyName, obj.ContactName, obj.ContactTitle, obj.Address, obj.City, obj.Region, obj.PostalCode, obj.Country, obj.Phone, obj.Fax, original.CustomerID);
		}
		
		[Function(Name="dbo.UpdateCustomers")]
		public ISingleResult<UpdateCustomersResult> UpdateCustomers([Parameter(Name="CustomerID", DbType="NChar(5)")] string customerID, [Parameter(Name="CompanyName", DbType="NVarChar(40)")] string companyName, [Parameter(Name="ContactName", DbType="NVarChar(30)")] string contactName, [Parameter(Name="ContactTitle", DbType="NVarChar(30)")] string contactTitle, [Parameter(Name="Address", DbType="NVarChar(60)")] string address, [Parameter(Name="City", DbType="NVarChar(15)")] string city, [Parameter(Name="Region", DbType="NVarChar(15)")] string region, [Parameter(Name="PostalCode", DbType="NVarChar(10)")] string postalCode, [Parameter(Name="Country", DbType="NVarChar(15)")] string country, [Parameter(Name="Phone", DbType="NVarChar(24)")] string phone, [Parameter(Name="Fax", DbType="NVarChar(24)")] string fax, [Parameter(Name="Original_CustomerID", DbType="NChar(5)")] string original_CustomerID)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), customerID, companyName, contactName, contactTitle, address, city, region, postalCode, country, phone, fax, original_CustomerID);
			return ((ISingleResult<UpdateCustomersResult>)(result.ReturnValue));
		}
	}
	...
	public partial class UpdateCustomersResult
	{
